...
simple_label_class_init (SimpleLabelClass *class)
{
  ...
  g_object_class_install_property (object_class, PROP_MIN_CHARS,
      g_param_spec_int ("min-chars", "Minimum Characters", "Minimum Characters",
                        0, G_MAXINT, 0,
                        G_PARAM_READWRITE));

  g_object_class_install_property (object_class, PROP_NAT_CHARS,
                            ...
                            int          min_chars)
{
  ...
  g_object_notify (G_OBJECT (self), "min-chars");
}
                            ...
                            int          nat_chars)
{
  ...
  g_object_notify (G_OBJECT (self), "nat-chars");
}
